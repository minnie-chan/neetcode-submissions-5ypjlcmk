...
public:
    vector<vector<int>> merge(vector<vector<int>>& intervals) {
       ...
       // sort(intervals.begin(), intervals.end());// i did not do this part neetcode ai did it idk why tho?
        vector<vector<int>> res;
        int n = intervals.size();
        int i = 0;
        int newStart = intervals[0][0];/// ok os i had this part right i j ust put  [1][0]but i almsot had it right 
